...
![devices-mockup](https://raw.githubusercontent.com/cotes2020/jekyll-theme-chirpy/master{{ site.baseurl }}/assets/img/sample/devices-mockup.png)
...
* 头像
    ...
    示例的头像文件放置在：`{{ site.baseurl }}/assets/img/sample/avatar.jpg`. 把它换成你自己的头像，路径不限定，越小越好。(压缩图像体积可上这个网站：*<https://tinypng.com/>* ).
